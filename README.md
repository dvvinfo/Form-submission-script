...
To run the script, add id="form" to the tag form.

you also need to create a  file server.php at the root of the site.

**Скрипт отправки формы**

Для работы скрипта добавьте id="form" к тегу form.

так же нужно создать файл server.php в корне сайта
```
